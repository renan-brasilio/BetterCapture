...
final class CaptureEngine: NSObject {
    ...
    private let videoSampleQueue = DispatchQueue(label: "com.capster.videoSampleQueue", qos: .userInteractive)
    private let audioSampleQueue = DispatchQueue(label: "com.capster.audioSampleQueue", qos: .userInteractive)
    private let microphoneSampleQueue = DispatchQueue(label: "com.capster.microphoneSampleQueue", qos: .userInteractive)
